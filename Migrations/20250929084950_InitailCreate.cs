        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialInvoiceTaxSerial = table.Column<int>(type: "int", nullable: false),
                    InitialCreditTaxSerial = table.Column<int>(type: "int", nullable: false),
                    InitialDebitTaxSerial = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ERPClientID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ERPClientSecret = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentLines_Documents_ReceiptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentLines_ReceiptId",
                table: "DocumentLines",
                column: "ReceiptId");
